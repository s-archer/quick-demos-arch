...
output "f5-2_eth1_1_ext_ip" {
  value = var.f5-2_eth1_1_ext_ips[0]
}
output "f5-2_eth1_1_ext_ip_vs0" {
  value = var.f5-2_eth1_1_ext_ips[1]
}
output "f5-2_eth1_1_ext_ip_vs1" {
  value = var.f5-2_eth1_1_ext_ips[2]
}
